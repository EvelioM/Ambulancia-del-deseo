<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <a class="navbar-brand" href="#">Ambulancia del deseo</a>    
    ...
    <div class="collapse navbar-collapse justify-content-md-center" id="navbarDeseo">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#">La Fundación</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="#">Solicitar deseo</a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
                    <a class="nav-link" href="#">Solicitar contacto</a>
            </li>
            <!--<li class="nav-item">
